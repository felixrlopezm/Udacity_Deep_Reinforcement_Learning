...
# of MADDPG agent and critic functions
#
# Architectures' code based on that described in the DDPG paper and modify accordingly to fit
...
class Critic(nn.Module):
    ...
    def __init__(self, num_agents, state_size, action_size, seed, fcs1_units=128, fc2_units=128):
